...
public class Help extends FrameFactory   {
	...
	public  void paint(Graphics g) {
		...
		g2d.drawString("Pressing space will trigger a dodge and your player become gray,", 50, 180);
		g2d.drawString("in this state you dont get any damage for less then a second.", 50, 210);
		g2d.drawString("There are green apple that spawn around the screen,", 50, 260);
		g2d.drawString("only when you eat one the other will spawn.", 50, 290);
